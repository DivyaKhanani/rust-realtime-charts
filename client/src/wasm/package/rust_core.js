 ...
 * @param {number} total_pairs
 * @param {number} target_pairs
 * @param {number | null | undefined} seed
 * @param {number} bias
 * @returns {Float32Array}
 */
export function generate_and_downsample(total_pairs, target_pairs, seed, bias) {
    const ret = wasm.generate_and_downsample(total_pairs, target_pairs, isLikeNone(seed) ? 0x100000001 : (seed) >>> 0, bias);
    return ret;
}
